const { practice, practiceOnDoctor, profileDoctor } = require("../models"), { createNotification } = require("../utils/notification");
    ...
    getAll: async(req, res, next) => {
        try {
            ...
            if (!existingPractice || existingPractice.length === 0)
                return res.status(403).json({ message: "Practice Empty" });
